...
public class CantidadDeCaminosMasCortosBFS {
	...
	public static void main(String[] args) {
		...
		int k = BFSCantidadDeCaminosMasCortos(n6,marcados,n2);
		System.out.println("Cantidad de caminos mínimos: " + k);
	}

	
	
	public static int BFSCantidadDeCaminosMasCortos(Nodo v, boolean[] marcados, Nodo destino) {
		int nivel[] = new int[9];
		int cantCaminos[] = new int[9];
		Queue q = new Queue();
		marcados[v.id] = true;
		nivel[v.id] = 1;
		q.enqueue(v);
